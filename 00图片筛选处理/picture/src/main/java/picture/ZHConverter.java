...
public class ZHConverter {
	...
	private ZHConverter(String propertyFileName) {
		...
		File propertyFile = new File("C:\\Code\\code\\dataAlgo101\\00Í¼Æ¬É¸Ñ¡´¦Àí\\picture\\src\\main\\resources\\"+propertyFileName);
